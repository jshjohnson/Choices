	        ...
	        if (parsedResults && (0, _utils.isType)('Array', parsedResults) && parsedResults.length) {
	          ...
	          parsedResults.forEach(function (result) {
	            if (result.choices) {
	              ...
	              _this15._addChoice((0, _utils.fetchFromObject)(result, value), (0, _utils.fetchFromObject)(result, label), result.selected, result.disabled, undefined, result.customProperties, result.placeholder);
	            }
	          });
