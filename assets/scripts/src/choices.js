...
import './choicesDeps/lib/polyfills';
import Store from './choicesDeps/store/store';
import {
  Dropdown,
  Container,
  Input,
  ...
  WrappedInput,
  WrappedSelect,
} from './choicesDeps/components';
import { DEFAULT_CONFIG, EVENTS, KEY_CODES } from './choicesDeps/constants';
import { TEMPLATES } from './choicesDeps/templates';
import {
  addChoice,
  filterChoices,
  activateChoices,
  clearChoices,
} from './choicesDeps/actions/choices';
import { addItem, removeItem, highlightItem } from './choicesDeps/actions/items';
import { addGroup } from './choicesDeps/actions/groups';
import { clearAll, resetTo } from './choicesDeps/actions/misc';
import { setIsLoading } from './choicesDeps/actions/general';
import {
  isScrolledIntoView,
  getAdjacentEl,
  getType,
