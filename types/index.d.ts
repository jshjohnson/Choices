...
declare namespace Choices {
  namespace Types {
    ...
    type passedElementType = 'select-one' | 'select-multiple' | 'text';
    ...
    type passedElement = HTMLInputElement | HTMLSelectElement;
  }
  ...
  interface Templates {
    ...
    item?: (
        globalClasses: Instance.ClassNames,
        data: itemData,
  ...
  interface Options {
     ...
     * @default null
     */
    callbackOnInit?: (this: Choices) => any;
     ...
     *         return template(`
     *           <div class="${globalClasses.item} ${data.highlighted ? globalClasses.highlightedState : globalClasses.itemSelectable}" data-item data-id="${data.id}" data-value="${data.value}" ${data.active ? 'aria-selected="true"' : ''} ${data.disabled ? 'aria-disabled="true"' : ''}>
     ...
     *         return template(`
     *           <div class="${globalClasses.item} ${globalClasses.itemChoice} ${data.disabled ? globalClasses.itemDisabled : globalClasses.itemSelectable}" data-select-text="${itemSelectText}" data-choice ${data.disabled ? 'data-choice-disabled aria-disabled="true"' : 'data-choice-selectable'} data-id="${data.id}" data-value="${data.value}" ${data.groupId > 0 ? 'role="treeitem"' : 'role="option"'}>
     *             <span>&bigstar;</span> ${data.label}
     *           </div>
     *         `);
     *       },
  ...
  namespace Instance {
    interface Options extends Choices.Options {
...
export default class Choices {
  _idNames: any;
  config: Choices.Instance.Options;
  ...
  containerOuter: Choices.containerOuter;
  input: Choices.input;
