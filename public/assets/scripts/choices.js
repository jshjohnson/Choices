...
function () {
  ...
  _proto._addEventListeners = function _addEventListeners() {
    ...
    this.containerOuter.element.addEventListener('mouseup', this._onMouseUp, true); // passive events - doesn't call `preventDefault` or `stopPropagation`
  ...
  _proto._removeEventListeners = function _removeEventListeners() {
    ...
    this.containerOuter.element.removeEventListener('mouseup', this._onMouseUp, true);
